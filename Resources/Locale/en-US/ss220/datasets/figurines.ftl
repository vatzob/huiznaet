...
figurines-griffin-4 = Если умеешь что-то, не делай это бесплатно
figurines-griffin-5 = Дело во мне, или весь мир сходит с ума?
...
figurines-thief-4 = Вчера ко мне в дом вломились воры и унесли все, кроме мыла, геля для душа, полотенца и дезодоранта! Грязные ублюдки!
figurines-thief-5 = Какая разница между вором и деревом? Дерево сажаешь, потом растет, а вор растет потом сажаешь.
