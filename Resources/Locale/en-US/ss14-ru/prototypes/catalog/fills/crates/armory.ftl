...
ent-CrateSecurityRiot = ящик снаряжения против беспорядков
    .desc = Содержит два комплекта противоударной брони, шлемов, щитов и дробовиков "Силовик", заряженных травматическими патронами. Дополнительные боеприпасы входят в комплект. Чтобы открыть, необходим доступ уровня Оружейной.
ent-CrateArmoryRifle = ящик винтовок
    .desc = Содержит две мощные штурмовые винтовки и четыре магазина. Чтобы открыть, необходим доступ уровня Оружейной.
